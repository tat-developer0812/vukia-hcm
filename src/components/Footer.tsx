  ...
  return (
    <footer className="bg-[#05141F] text-white">
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        {/* Dòng xe */}
        <div>
          <h3 className="font-bold text-sm uppercase tracking-wider mb-4 text-white">Dòng xe KIA</h3>
        ...
        {/* Links */}
        <div>
          <h3 className="font-bold text-sm uppercase tracking-wider mb-4 text-white">Dịch vụ</h3>
          <ul className="space-y-2">
            {[
        ...
        {/* Contact */}
        <div>
          <h3 className="font-bold text-sm uppercase tracking-wider mb-4 text-white">Liên hệ</h3>
          <ul className="space-y-3">
            ...
            <li className="flex items-center gap-3">
              ...
              <a href={`mailto:${contact.email}`} className="text-gray-300 hover:text-[#BB162B] text-sm transition-colors">
                {contact.email}
              </a>
            </li>
            <li className="flex items-start gap-3">
