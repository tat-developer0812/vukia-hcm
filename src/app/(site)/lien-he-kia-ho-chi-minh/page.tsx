  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-[#05141F] to-[#0d2137] py-16 px-4 text-white text-center">
        <h1 className="text-4xl font-black mb-2">Liên hệ Showroom KIA Gò Vấp</h1>
        <div className="w-14 h-1 bg-[#BB162B] mx-auto mt-3 mb-4" />
        <p className="text-gray-300 text-sm">189 Nguyễn Oanh, Phường 10, Quận Gò Vấp, TP HCM · Tư vấn viên sẵn sàng hỗ trợ bạn mọi lúc</p>
      </div>

      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 lg:grid-cols-2 gap-10">
        {/* Contact info */}
        <div className="space-y-5">
          <h2 className="text-2xl font-black text-[#05141F]">Địa chỉ KIA Nguyễn Oanh – Gò Vấp</h2>
          {[
            {
